<script lang="ts">
  ...
  const positionAxes = $derived([
    { key: 'x' as PositionAxis, label: 'X', value: viewerState.cameraPositionX, target: viewerState.cameraTargetX },
    { key: 'y' as PositionAxis, label: 'Y', value: viewerState.cameraPositionY, target: viewerState.cameraTargetY },
    { key: 'z' as PositionAxis, label: 'Z', value: viewerState.cameraPositionZ, target: viewerState.cameraTargetZ },
  ]);
